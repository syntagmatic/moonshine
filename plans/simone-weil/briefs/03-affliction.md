...
- *Gravity and Grace*, clusters on affliction, violence, necessity, and love of God.
- Factory writings and factory journal material for the experiential hinge.
- *Waiting for God* for later reflections on affliction.
- SEP discussion of the shift from oppression/humiliation to `malheur`.
...
- `malheur`: affliction.
- humiliation: social degradation, prominent in the factory context.
- necessity: the impersonal order that can crush without hatred.
- attention: required to perceive affliction truthfully.

## Misreadings to avoid

- Do not romanticize affliction or present it as automatically ennobling.
- Do not treat affliction as a psychological category only.
- Do not suggest the afflicted are morally superior by suffering.
- Do not make factory experience into a biographical anecdote; it changes the concepts.

## Bridge notes

Affliction is the hinge from Act I back into Act II. The page should leave readers prepared to recognize factory labor, war, and bureaucracy as different ways social force can enter the body and self-relation. It should also show why attention is ethical: without it, affliction is usually misread or made invisible.

## Reader takeaway

Affliction is suffering that destroys a person's ordinary footholds in body, status, and self-relation. To see it requires attention; to sentimentalize it is already to miss it.
